...
@interface NoticeWaitTableViewCell () {
}

@end

@implementation NoticeWaitTableViewCell
...
//        [self.contentView addSubview:self.profileImageView];
        ...
        timeLab.frame = CGRectMake(0, 5, 300, 20);
        timeLab.backgroundColor = [UIColor clearColor];
        [groupView addSubview:timeLab];
        
        UILabel *infoLab = [[UILabel alloc]init];
        infoLab.text  = @"等待施助者救助,请稍等...";
        infoLab.textAlignment = NSTextAlignmentCenter;
        infoLab.font  = [UIFont systemFontOfSize:14];
        infoLab.frame = CGRectMake(0, 25, 300, 20);
        ...
        NSDictionary *dic = [NSDictionary dictionaryWithObjectsAndKeys:timeStr,@"TIME",[NSNumber numberWithLong:seconds],@"SECONDS",timeLab,@"TIMELABEL", nil];
...
- (void) timeOut:(NSTimer *)theTimer
{
    ...
    timeLab.text = [NSString stringWithFormat:@"%d分%d秒", minute,second];
}
